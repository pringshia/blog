...
A special thanks to the [Recurse Center](https://recurse.com) and to fellow Recursers for starting the [Iron Blogger challenge](http://blog.lazerwalker.com/2013/12/24/one-post-a-week-running-an-iron-blogger-challenge). This helped me to get inspired and create the momentum that's jumpstarting this blog.